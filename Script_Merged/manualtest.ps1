# =============================================================================
# manualtest.ps1 - Script de test rapide avec chemins en dur
# =============================================================================
# Ce fichier permet d'effectuer des tests rapides sans sélection interactive.
# Modifiez directement les chemins ci-dessous selon vos besoins de test.
# =============================================================================
...
# Load Windows Forms for loading window
